...
```bash
mkdir solang-erc20 && cd solang-erc20
mkdir src out
```
...
- Multi‑target output (EVM, Solana, Substrate)
- Useful diagnostics and stricter checks
- Easier embedding in Rust pipelines

### Trade‑offs

- Smaller ecosystem than `solc`
- Not fully compatible with Etherscan auto‑verification
- Some Solidity edge cases differ

---

## Next Steps

- Add mint and burn functionality with access control
- Compare gas output vs `solc`
- Try compiling the same contract for Solana
- Integrate Solang into a Rust‑based deployment tool
